...
def createAconMatNodeGroups():
    ...
    toggleToonEdge(None, context)
    toggleToonFace(None, context)
    toggleTexture(None, context)
    toggleShading(None, context)
    changeToonDepth(None, context)
    changeImageAdjustBrightness(None, context)
    changeImageAdjustContrast(None, context)
    changeImageAdjustColor(None, context)
    changeImageAdjustHue(None, context)
    changeImageAdjustSaturation(None, context)
    changeImageAdjustSaturation(None, context)
...
def applyAconToonStyle():
    ...
    for mat in bpy.data.materials:
        ...
        if node_combinedToon:
            ...
            toggleEachEdge(None, override)
            toggleEachShading(None, override)
            toggleEachShadow(None, override)
        ...
        for node in nodes:
            if node not in [node_texImage, node_combinedToon, out_node]:
