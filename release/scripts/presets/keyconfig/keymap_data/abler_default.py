...
def km_object_mode(params):
    ...
    items.extend([
        ...
        *_template_items_select_actions(params, "object.select_all"),
        ...
        ("anim.keyframe_delete_v3d", {"type": 'I', "value": 'PRESS', "alt": True}, None),
        ("anim.keying_set_active_set", {"type": 'I', "value": 'PRESS', "shift": True, "ctrl": True, "alt": True}, None),
        ("acon3d.create_group", {"type": 'G', "value": 'PRESS', "ctrl": True}, None),
        ("acon3d.explode_group", {"type": 'G', "value": 'PRESS', "ctrl": True, "alt": True}, None),
...
def km_view3d_fly_modal(_params):
    ...
    items.extend([
        ...
        ("CANCEL", {"type": 'DEL', "value": 'PRESS', "any": True}, None),
